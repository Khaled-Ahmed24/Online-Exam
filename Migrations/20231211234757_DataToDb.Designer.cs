...
namespace Online_Exam1._0.Migrations
{
    ...
    [Migration("20231211234757_DataToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Online_Exam1._0.Models.Answers", b =>
                {
            ...
            modelBuilder.Entity("Online_Exam1._0.Models.Choices", b =>
                {
                    b.Property<int>("Exam_id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("Online_Exam1._0.Models.Exam", b =>
                {
                    b.Property<int>("Exam_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Online_Exam1._0.Models.Questions", b =>
                {
                    b.Property<int>("Exam_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Online_Exam1._0.Models.User", b =>
                {
                    b.Property<string>("U_Email")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Online_Exam1._0.Models.Answers", b =>
                {
                    b.HasOne("Online_Exam1._0.Models.User", "UEmailNavigation")
                        .WithMany("Answers")
                        .HasForeignKey("U_Email")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Online_Exam1._0.Models.Questions", "Questions")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Online_Exam1._0.Models.Exam", b =>
                {
                    b.HasOne("Online_Exam1._0.Models.User", "AdminstrationEmailNavigation")
                        .WithMany("Exams")
            ...
            modelBuilder.Entity("Online_Exam1._0.Models.Questions", b =>
                {
                    b.HasOne("Online_Exam1._0.Models.Exam", "Exam")
                        .WithMany("Questions")
